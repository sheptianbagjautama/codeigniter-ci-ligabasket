 ...
 */
$config['site_title']                 = "ligabasket.com";       // Site Title, example.com
$config['admin_email']                = "heritechie@gmail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'team';           // Default group, use name
